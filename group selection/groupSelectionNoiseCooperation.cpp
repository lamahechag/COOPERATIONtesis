...
int main () 
{
double r1,r2,p0,p1,sigma0=0.1,sigma1=0.1,mean0=3.5,mean1=4,beneficio=10;
int n=100, m=1, randomm, N=n*m, randomn, randomn1,i0=50;
...
// 1 cooperate, 0 no cooperate and 2 no individual
 ...
 for(int j=n*i; j<(n*(i+1)); j++)
   {double individualUtility;
     if(A[j]==1){ individualUtility=Benefit-AcooLevel[j]; if(individualUtility<0){individualUtility=0;};
       utility1=utility1+individualUtility;  /* cout<<Benefit-AcooLevel[j]<<" "<<AcooLevel[j]<<endl;*/}
     if(A[j]==0){ individualUtility=Benefit-AcooLevel[j]; if(individualUtility<0){individualUtility=0;};     
       utility0=utility0+individualUtility;/* cout<<Benefit-AcooLevel[j]<<" "<<AcooLevel[j]<<endl;*/}
     } 
